...
#ifndef _IS_INCLUDED_ST_HPP
#define _IS_INCLUDED_ST_HPP
...
**===========================================================================
*/
extern"C" void spi0_init(void);
extern"C" void spi0_rd_status(void);

extern"C" void wr_st(unsigned int addr, void *src, unsigned int count);
extern"C" void rd_st(unsigned int addr, void *dest, unsigned int count);
