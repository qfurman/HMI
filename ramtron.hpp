...
#ifndef _IS_INCLUDED_RAMTRON_HPP
#define _IS_INCLUDED_RAMTRON_HPP
...
extern"C" void spi1_rd_status(void);
extern"C" void spi1_rd_status_flash(void);
extern"C" void spi1_WEL(void);
extern"C" void rd_flash(unsigned int addr, void *dest, unsigned int count);
extern"C" void wr_flash(unsigned int addr, void *src, unsigned int count);

extern"C" void wr_rmtrn(unsigned int addr, void *src, unsigned int count);
extern"C" void rd_rmtrn(unsigned int addr, void *dest, unsigned int count);
